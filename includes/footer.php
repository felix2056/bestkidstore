      ...
      <div class="grid grid--no-gutters">
        <div class="grid__item text-center">
          ...
          <ul class="site-footer__linklist site-footer__linklist--center">
            ...
            <li class="site-footer__linklist-item">
              <a href="/pages/shipping-policy.php">Returns &amp; Refunds</a>
            </li>
      ...
      <div class="grid grid--no-gutters">
        ...
        <div class="grid__item text-center">
          <ul class="list--inline site-footer__social-icons social-icons">
            ...
            <li>
              <a class="social-icons__link" href="#" title="bestkidstore on Facebook">
            ...
            <li>
              <a class="social-icons__link" href="#" title="bestkidstore on Instagram">
        ...
        <div class="grid__item text-center">
          <div class="site-footer__copyright">
            <small class="site-footer__copyright-content">© 2020, <a href="/" title="">bestkidstore</a></small>
          </div>
        </div>
      </div>
