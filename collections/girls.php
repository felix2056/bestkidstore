...
<?php require_once('../products/db/girls_cat.php'); ?>


<?php
    $products = json_decode(getAllGirls(), true);
?>
                            ...
                            <div class="filters-toolbar">
                                <div class="filters-toolbar__item">
                                    ...
                                    <select class="filters-toolbar__input filters-toolbar__input--filter"
                                        ...
                                        <option value="/collections/girl/girl">girl</option>
                                    </select>
                                </div>
                                ...
                                <a class="grid-view-item__link grid-view-item__image-container"
                                    ...
                                    <div id="ProductCardImageWrapper-collection-template-2072545001570"
                                        ...
                                        <div style="padding-top:125.0877193%;">
                                            <img id="ProductCardImage-collection-template-2072545001570"
                                                ...
                                                data-aspectratio="0.7994389901823282" data-sizes="auto"
                                                alt="<?php echo $product['title'] ?>"
                                                data-srcset="<?php echo $product['featured_image'] ?> 2048w"
                                                sizes="200px" srcset="<?php echo $product['featured_image'] ?> 2048w">
                                        </div>
                                    </div>
                                    ...
                                    <noscript>
                                        ...
                                        <img class="grid-view-item__image"
                                            src="<?php echo $product['featured_image'] ?>"
                                            alt="<?php echo $product['title'] ?>"
                                            style="max-width: 199.85974754558205px;">
                                    </noscript>
